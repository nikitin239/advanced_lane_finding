...
def calculate(binary_warped, left_line, right_line):
    ...
    if (len(leftx)>0): left_detected = True
    if (len(rightx)>0): right_detected = True
    ...
    return(left_detected,right_detected,leftx,lefty,rightx,righty)
